<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/StudentRegMain.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ThreeTireWorkshop.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="login"><br />&nbsp&nbsp&nbsp
